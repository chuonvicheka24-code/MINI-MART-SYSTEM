...
<section class="section">
  <div class="wrap cart-layout" id="cart-wrap">
    ...
    <div class="card">
      ...
      <p id="empty-cart" style="display:none; margin-top:8px;">Your basket is empty. <a href="<?php echo e(route('products.index')); ?>" style="text-decoration:underline; color:var(--brand-dark); font-weight:600;">Go find something fresh →</a></p>
    </div>
    ...
    <div class="card">
      ...
      <a href="<?php echo e(route('checkout.index')); ?>" class="btn btn-primary btn-block" style="margin-top:16px;" id="checkout-btn">Proceed to Payment</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\minimart\resources\views/cart/index.blade.php ENDPATH**/ ?>