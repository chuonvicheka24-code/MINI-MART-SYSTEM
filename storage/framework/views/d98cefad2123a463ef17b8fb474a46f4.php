<?php $__env->startSection('title', 'Products — Mini Mart'); ?>

<?php $__env->startSection('content'); ?>

<section class="section" style="padding-top:26px;">
  <div class="wrap">
    <div class="crumb"><a href="<?php echo e(route('home')); ?>">Home</a> &nbsp;›&nbsp; <span id="crumb-cat">All Products</span></div>
...
<script>
  window.MM_PRODUCTS = <?php echo json_encode($products->map->toStorefrontArray(), 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\minimart\resources\views/products/index.blade.php ENDPATH**/ ?>