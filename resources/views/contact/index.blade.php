...
@section('title', 'Contact — Mini Mart')
...
<section class="section">
  <div class="wrap contact-layout">
    ...
    <form class="form-card" id="contact-form" onsubmit="submitContact(event)">
      <div class="field"><label for="c-name">Your Name</label><input id="c-name" value="{{ auth()->user()->name ?? '' }}" required></div>
      <div class="field"><label for="c-email">Your Email</label><input id="c-email" type="email" value="{{ auth()->user()->email ?? '' }}" required></div>
